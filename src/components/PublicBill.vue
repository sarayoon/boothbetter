    ...
    <b-row>
      <b-col class="xs-10">
        <div class="invoice-title">
          <h3
            class="h3"
          >Welcome, {{vendor.contact_name}}! Here is your bill from Street Fair Productions.</h3>
          <h3 class="h2 float-right"># {{bill.id}}</h3>
        </div>
        <hr>
        <b-row>
          <b-col class="xs-6">
...
export default {
  ...
  created() {
    ...
    this.$store.dispatch('getPublicBill', this.id);
  },
};
</script>
<style>
